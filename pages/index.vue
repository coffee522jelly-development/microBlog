<template>
  <ul class="grid sm:grid-cols-2 grid-cols-1 gap-8 col-span-3 md:col-span-8">
    <div v-for="blog in data?.contents" :key="blog.id" class="max-w-sm bg-white border border-gray-200 rounded-lg shadow">
      <NuxtLink :to="`/${blog.id}`">
        <a href="#">
            <img :src="blog.eyecatch?.url" class="rounded-t-lg" alt="" />
        </a>
        <div class="p-5">
            <a href="#">
            ...
            <p class="mb-3 font-normal text-gray-700">{{ blog.explain }}</p>
